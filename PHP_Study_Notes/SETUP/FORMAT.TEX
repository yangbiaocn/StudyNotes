...
\definecolor{gray}{rgb}{0.5,0.5,0.5}%灰
...
\newtheorem{definition}{\indent\color{white}定义}[chapter]
...
\newtheorem{cexample}{\hspace{2em}\hei\color{white}C程序}[section]
\newcommand{\cprogram}[1]{\noindent\parbox{14.6cm}{\includegraphics[width=3.1cm]{fig/sjwt.jpg}
\vspace{-1.12cm}\cexample\textcolor{darkblue}{\hei#1}}\vspace{0.0cm}}  %实际问题标志
...
\lstdefinestyle{customasm}{
  ...
  basicstyle=\footnotesize\ttfamily,
  commentstyle=\itshape\color{purpleblack},
}
